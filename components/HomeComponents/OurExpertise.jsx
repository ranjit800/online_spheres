...
//     description:
//       "We help your brand reach more people with optimized ad campaigns across platforms like Google, Facebook, and Instagram — designed for visibility and conversion.",
//   },
// ];
...
// const OurExpertise = () => {
//   return (
//     <section className="py-20 px-4 md:px-12 text-white overflow-hidden max-w-[1300px] mx-auto">
...
//           We provide the best web technologies present in the market to boost
//           your business
//         </p>
//       </motion.div>
...
//                 whileHover="hover"
//                 className="group relative border border-[#02337B] rounded-2xl p-6 backdrop-blur-sm flex flex-col text-left w-full max-w-xs bg-gradient-to-tr from-[#000000]/5 to-[#4511d6b1] transition-all duration-300 ease-out overflow-hidden shadow-lg hover:shadow-[0_8px_32px_0_rgba(0,255,208,0.18)] hover:border-[#00FFD0] hover:bg-gradient-to-tr hover:from-[#0e1a1a]/60 hover:to-[#00FFD0]/10"
//               >
//                 {/* Icon */}
//                 <div className="relative w-16 h-16 mb-4 z-10 flex items-center justify-center bg-transparent p-2 rounded-xl shadow-md">
//                   <Image
//                     src={item.icon}
//                     alt={item.title}
//                     width={64}
...
//                 <h3 className="text-lg font-semibold mb-2 group-hover:text-[#00FFD0] transition-colors duration-300">
//                   {item.title}
//                 </h3>
//                 <p className="text-sm text-gray-400 group-hover:text-gray-100 transition-colors duration-300">
//                   {item.description}
//                 </p>
//               </motion.div>
//             ))}
...
const OurExpertise = () => {
  return (
   ...
   <div className=" relative py-20 px-4 md:px-12  text-white overflow-hidden">
      <Image src={background} alt="Abstract background" fill className="object-cover z-0 opacity-90 rounded-2xl" />
